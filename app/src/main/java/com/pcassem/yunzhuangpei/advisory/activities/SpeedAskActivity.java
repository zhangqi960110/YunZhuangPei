...
import static com.pcassem.yunzhuangpei.advisory.activities.ExportAnswerActivity.IMAGE_ITEM_ADD;

public class SpeedAskActivity extends AppCompatActivity implements View.OnClickListener,ConsultView,ImagePickerAdapter.OnRecyclerViewItemClickListener  {

    private static final String TAG = "SpeedAskActivity";
        ...
        switch (v.getId()) {
            ...
            case R.id.submit:
                if (isSubmit()){
                    ...
                    presenter.addQuickConsult(common);
                }
                break;
        }
    }
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            case 0:
                                ...
                                Intent intent = new Intent(SpeedAskActivity.this, ImageGridActivity.class);
                                intent.putExtra(ImageGridActivity.EXTRAS_TAKE_PICKERS, true);
                                startActivityForResult(intent, REQUEST_CODE_SELECT);
                                break;
                            case 1:
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(SpeedAskActivity.this, ImageGridActivity.class);
    ...
    public void onAddCommonConsultSuccess(ResultListEntity<String> result) {
        if (result.getCode() == 0){
            ...
            Toast.makeText(this, "提交失败1", Toast.LENGTH_SHORT).show();
        }
    }

    @Override
    public void onAddCommonConsultError() {
        Toast.makeText(this, "提交失败2", Toast.LENGTH_SHORT).show();
    }
    ...
    private void myDialog() {
        new CommomDialog(SpeedAskActivity.this, R.style.commom_dialog, "没有项目，请新建项目", new CommomDialog.OnCloseListener() {
            @Override
            public void onClick(Dialog dialog, boolean confirm) {
                if (confirm) {
                    Intent intent = new Intent(SpeedAskActivity.this, MyProjectActivity.class);
                    startActivity(intent);
                    dialog.dismiss();
                    SpeedAskActivity.this.finish();
                } else {
