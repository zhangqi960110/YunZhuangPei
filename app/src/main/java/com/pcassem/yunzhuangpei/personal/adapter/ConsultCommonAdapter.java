...
public class ConsultCommonAdapter extends BaseExpandableListAdapter {
    ...
    public ConsultCommonAdapter(Context context, List<String> groups, List<List<ConsultEntity>> childs) {
        mContext = context;
        this.groups = groups;
        this.childs = childs;
    }
