...
public class ConsultCommonActivity extends AppCompatActivity implements View.OnClickListener, ConsultView {

    ExpandableListView expandableListView;
    ConsultCommonAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_consult_common);
        ...
        presenter.onCreate();
        presenter.commonConsult(this.getIntent().getIntExtra("child_consult",-1));
    ...
    public void onSuccess(ResultListEntity<ConsultEntity> status) {
        if (status.getCode() == 0){
            ...
            adapter = new ConsultCommonAdapter(this, groups, childs);
