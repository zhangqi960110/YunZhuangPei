...
import com.pcassem.yunzhuangpei.personal.adapter.ConsultQuickAdapter;
...
public class ConsultQuickActivity extends AppCompatActivity implements View.OnClickListener,ConsultView {

    ExpandableListView expandableListView;
    ConsultQuickAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_consult_quick);
        ...
        presenter.onCreate();
        presenter.quickConsult(this.getIntent().getIntExtra("child_consult",-1));
    ...
    private void initData(){
        ...
        childs = new ArrayList<List<ConsultEntity>>();
    }
    ...
    @Override
    public void onSuccess(ResultListEntity<ConsultEntity> status) {
        if (status.getCode() == 0){
            ...
            adapter = new ConsultQuickAdapter(this, groups, childs);
